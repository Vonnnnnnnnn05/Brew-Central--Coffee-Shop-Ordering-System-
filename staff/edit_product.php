...
if (isset($_POST['update_product'])) {
    ...
    if (mysqli_query($conn, $query)) {
        ...
        if ($old_stock != $new_stock) {
            ...
            $change_type = $quantity_changed > 0 ? 'add' : 'remove';
            $remarks = "Stock updated from $old_stock to $new_stock";
            
            $log_query = "INSERT INTO inventory_logs (product_id, changed_by, change_type, quantity_changed, remarks) 
                          VALUES ('$product_id', '$user_id', '$change_type', '" . abs($quantity_changed) . "', '$remarks')";
            ...
            <form method="POST" enctype="multipart/form-data">
              ...
              <div class="mb-3">
                ...
                <?php if ($product['image']): ?>
                  <div class="mb-2">
                    <img src="../<?php echo $product['image']; ?>" width="150" style="object-fit: cover;">
                  </div>
                <?php endif; ?>
